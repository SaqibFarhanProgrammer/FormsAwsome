...
function FieldError({ error }: { error?: string }) {
  return error ? <p className="mt-1 text-xs font-medium text-black">{error}</p> : null;
}
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0">
          <Label className="text-sm font-medium text-black">
            {field.label}
            {field.validation.required && <span className="ml-1 text-black">*</span>}
          </Label>
            ...
            <>
              ...
              <form onSubmit={handleSubmit(submit)} className="space-y-4">
                ...
                <div className="pt-2">
                  ...
                  {submitError && (
                    <div className="mt-3 flex items-center justify-center gap-1.5 rounded-md border border-black/20 bg-white px-3 py-2 text-xs font-medium text-black">
