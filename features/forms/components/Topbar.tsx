...
import { ArrowLeft, Eye, Save, Share2, Settings, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="h-16 border-b border-border bg-card flex items-center justify-between px-6 flex-shrink-0">
      <div className="flex items-center gap-4">
        ...
        <Badge variant="secondary" className="rounded-lg text-xs bg-amber-50 text-amber-700 border-amber-200/50">
          Draft
        </Badge>
      </div>
